                ...
                child: AnimatedOpacity(
                  ...
                  child: AnimatedSlide(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text('A', style: TextStyle(color: Colors.white54, fontSize: 12, letterSpacing: 2)),
                        ...
                        const SizedBox(height: 6),
                        const Text('PRODUCT', style: TextStyle(color: Colors.white54, fontSize: 10, letterSpacing: 5, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                ),
