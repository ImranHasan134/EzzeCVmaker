        ...
        actions: [
          TextButton(
            ...
            child: Text('Skip to Templates',
                style: TextStyle(color: isDark ? Colors.white70 : Colors.white.withOpacity(0.55), fontSize: 12)),
          ),
        ],
      ),
      body: Column(
...
class _PersonalInfoStepState extends State<PersonalInfoStep> {
  ...
  // THE FIXED 1:1 CIRCULAR CROPPER
      ...
      CroppedFile? croppedFile = await ImageCropper().cropImage(
        ...
        uiSettings: [
          AndroidUiSettings(
            ...
            toolbarColor: AppTheme.bgDeep,
            toolbarWidgetColor: Colors.white,
            initAspectRatio: CropAspectRatioPreset.square,
            lockAspectRatio: true,
            cropStyle: CropStyle.circle, // Moved inside Android settings
          ),
          IOSUiSettings(
            title: 'Crop Profile Photo',
            aspectRatioLockEnabled: true,
            cropStyle: CropStyle.circle, // Moved inside iOS settings
          ),
        ],
      );

      if (croppedFile != null) {
        setState(() => _info.photoPath = croppedFile.path);
        _update();
      }
    }
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
              ...
              child: Stack(
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: _info.photoPath != null ? FileImage(File(_info.photoPath!)) : null,
                    child: _info.photoPath == null ? const Icon(Icons.person, size: 40, color: AppTheme.primaryBlue) : null,
                  ),
                  Container(
          ...
          Center(child: Text('Upload Photo (Optional)\nVisible in Modern & Academic templates.', textAlign: TextAlign.center, style: TextStyle(fontSize: 10, color: isDark ? Colors.white70 : Colors.grey))),
    ...
    return _CollapsibleCard(
      ...
      child: Column(
        children: [
          ...
          SwitchListTile(
            title: Text('Current Job', style: TextStyle(fontSize: 13, color: Theme.of(context).brightness == Brightness.dark ? Colors.white70 : AppTheme.textSecondary)),
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Technical & Soft Skills',
              style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: isDark ? Colors.white : AppTheme.textPrimary)),
          const SizedBox(height: 12),
          ...
          const SizedBox(height: 24),
          Divider(color: isDark ? Colors.white12 : AppTheme.divider),
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: filled ? AppTheme.primaryBlue : (isDark ? Colors.white12 : AppTheme.divider),
                  ),
                ),
              );
            }),
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.all(4),
                    decoration: BoxDecoration(
                      color: isDark ? Colors.white10 : AppTheme.bgSurface,
                      borderRadius: BorderRadius.circular(6),
                    ),
                    child: Icon(
    ...
    return Column(
      children: [
        Container(
          padding: const EdgeInsets.all(20),
          decoration: BoxDecoration(
            color: isDark ? Colors.white12 : AppTheme.divider.withOpacity(0.5),
            shape: BoxShape.circle,
          ),
          child: Icon(icon, size: 36, color: isDark ? Colors.white54 : AppTheme.textMuted),
        ),
